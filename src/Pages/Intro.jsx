...
function Intro() {
  ...
  return (
    <section
      id="intro"
      className="min-h-screen flex flex-col justify-center items-center text-center px-4 sm:px-6 md:px-10 lg:px-20 
    ...
    >
      ...
      <p className="max-w-md sm:max-w-lg md:max-w-2xl text-gray-600 dark:text-gray-400 text-sm sm:text-base md:text-lg mb-8">
